...
export const responce: Response = {
  ...
  'items': [
  {
    ...
    'snippet': {
      ...
      'description': 'Полный курс по Angular 8+:\nhttps://clc.to/angular\n\nTelegram: ' +
        ...
        ' релиз Angular 8 и я решил записать' +
        '  по нему быстрый курс. В видео вы узнаете, как Angular' +
        ' работает, как его установить.\nВ результате урока' +
        ' я покажу создание Todo приложения с разными подходами.' +
      ...
      'localized': {
        ...
        'description': 'Полный курс по Angular 8+:\nhttps:' +
          ...
          '\n\nReact Native: мобильная разработка на ' +
          'JavaScript:\nhttps://clc.to/rnative\n\n' +
          'Поддержать выпуск новых видео:\nЯД: https:' +
          '//money.yandex.ru/to/410013757655670\nPayPal:' +
          ' https://www.paypal.me/vladilenm \n\n30 мая ' +
          '2019 года бы релиз Angular 8 и я решил записать ' +
          ' по нему быстрый курс. В видео вы узнаете,' +
          ' как Angular работает, как его установить.\nВ ' +
          'результате урока я покажу создание Todo ' +
          'приложения с разными подходами. Разберем работу с' +
          ' сервером, сервисами, пайпами, к' +
          'оммуникацией между компонентами и немного RxJS\n\nИсходный ' +
          'код:\nhttps://github.com/vladilenm/angular8-cc\n\nAngular' +
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'In this video we will talk about what ' +
        'Angular is and then jump in and ' +
        'build a small app With Angular 7, looking at most' +
        ' of the fundamental concepts like ' +
        'components, services, modules, etc\n\nSponsor:' +
        '\nhttp://www.netlify.com\n\nCode:' +
        '\nhttps://github.com/bradtraversy/angular' +
        '-crash-todolist\n\n💖 Become a Patron: ' +
        'Show support & get perks!\nhttp://www.' +
      ...
      'localized': {
        'title': 'Angular Crash Course',
        'description': 'In this video we will talk' +
          ' about what Angular is and then jump in ' +
          'and build a ' +
          'small app With Angular 7, looking at most' +
          ' of the fundamental concepts like components, services,' +
          ' modules, etc\n\nSponsor:\nhttp://www.netlify.' +
          ...
          '://www.twitter.com/traversymedia\nhttps:/' +
          '/www.instagram.com/traversymedia'
      },
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': '🔥Get the COMPLETE COURSE (60% OFF - LIMITED TIME): ' +
        ...
        '\n\nThis Angular tutorial teaches ' +
        'you the fundamentals of Angular and TypeScript.' +
        '\n\nSUBSCRIBE FOR MORE VIDEOS!' +
        '\nhttps://www.youtube.com/channel/UCWv7vMbMWH4-' +
        'V0ZXdmDpPBA?sub_confirmation=1\n\n' +
        '\nTABLE OF CONTENT \n\n00:00 Introduction\n02:54 ' +
        'What is Angular?\n04:54 Architecture ' +
        'of Angular Apps\n08:41 Setting Up the Development' +
        ' Environment\n11:25 Your First Angular ' +
        ...
        ' Modifiers in Constructor Parameters\n01:12:58' +
        ' Properties\n01:18:15 Modules\n01:23:22 Angular ' +
        'Fundamentals\n01:23:41 Building Blocks of' +
        ' Angular Apps\n01:27:22 Creating Components\n' +
        '01:37:00 Generating Components Using Angular' +
        ' CLI\n01:41:40 Templates\n01:44:08 Directives' +
        '\n01:47:34 Services\n01:52:02 Dependency ' +
        'Injection\n01:59:22 Generating Services Using ' +
        'Angular CLI\n02:01:32 Exercise\n \n\nSTAY' +
      ...
      'localized': {
        ...
        'description': '🔥Get the COMPLETE COURSE (60% OFF - LIMITED TIME): ' +
          'https://programmingwithmosh.com/courses/angular' +
          '\n\nThis Angular' +
          ' tutorial teaches you the fundamentals of ' +
          'Angular and TypeScript.\n' +
          '\nSUBSCRIBE FOR MORE VIDEOS!\nhttps://www.' +
          'youtube.com/channel/UCWv7vMbMWH4-' +
          'V0ZXdmDpPBA?sub_confirmation=1\n\n\nTABLE ' +
          'OF CONTENT \n\n00:00 Introduction' +
          ...
          'Interfaces\n56:54 Classes\n01:01:22 Objects\n01:05:31' +
          ' Constructors\n01:08:22 Access Modifiers\n' +
          '01:11:18 Access Modifiers in Constructor ' +
          'Parameters\n01:12:58 Properties\n01:18:15 ' +
          'Modules\n01:23:22 Angular Fundamentals\n01:23:41 ' +
          'Building Blocks of Angular Apps\n01:27:22 ' +
          'Creating Components\n01:37:00 Generating ' +
          'Components Using Angular CLI\n01:41:40 ' +
          'Templates\n01:44:08 Directives\n01:47:34' +
          ' Services\n01:52:02 Dependency Injection\n01:59:22' +
          ' Generating Services Using Angular' +
          ' CLI\n02:01:32 Exercise\n \n\nSTAY IN TOUCH\n\n' +
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'Полный курс по Angular 8+:\n' +
        'https://clc.to/angular\n\nДобавляйте меня в' +
        ' ВК: https://vk.com/vladilen.minin\nTelegram:' +
        ' https://teleg.one/js_by_vladilen\nInstagram: ' +
        'https://www.instagram.com/vladilen.minin\nГруппа' +
        ' ВК: https://vk.com/js_by_vladilen\n\nПоддержать ' +
        'выпуск новых видео:\nЯД: https://money.yandex.ru' +
        '/to/410013757655670\nPayPal:' +
        ' https://www.paypal.me/vladilenm \n\nУрок по ' +
        'Angular. В этом курсе вы познакомитесь ' +
        'со всеми основными элементами, которые есть в ' +
        'Angular с полного нуля\n\nAngular 8 Основы. ' +
        'Полный Курс. Урок для Новичков',
      'thumbnails': {
        'default': {
      ...
      'localized': {
        ...
        'description': 'Полный курс по Angular 8+' +
          ...
          '\nPayPal:' +
          ' https://www.paypal.me/vladilenm \n\nУрок по Angular. ' +
          'В этом курсе вы познакомитесь ' +
          'со всеми основными элементами, которые есть в Angular ' +
          'с полного нуля\n\nAngular 8 Основы. ' +
          'Полный Курс. Урок для Новичков'
      },
      'defaultAudioLanguage': 'en-US'
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'В этом видео речь пойдет про javascript' +
        ' фреймворк Angular. Я расскажу что такое ' +
        'Angular, где и когда его применяют, а так же сделаю ' +
        'небольшой обзор его возможностей. Расскажу ' +
        'чем фреймворк сложен для новичков и чем он' +
        ' действительно хорош для новых проектов. Сейчас для того' +
        ' что б стать junior javascript разработчиком ' +
        'нужно обязательно знать хотя бы один фреймворк js и' +
        ' ангуляр будет отличным выбором.',
      'thumbnails': {
        'default': {
      ...
      'localized': {
        'title': 'Что такое Angular. Обзор возможностей',
        'description': 'В этом видео речь пойдет про' +
          ' javascript фреймворк Angular. Я расскажу что такое ' +
          'Angular, где и когда его применяют, а так' +
          ' же сделаю небольшой обзор его возможностей. Расскажу ' +
          'чем фреймворк сложен для новичков и чем он' +
          ' действительно хорош для новых проектов. Сейчас для того ' +
          'что б стать junior javascript разработчиком' +
          ' нужно обязательно знать хотя бы один фреймворк js и ' +
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'When youre just starting out you are' +
        ' probably wondering "What is Angular exactly?' +
        ' When you ask that question it leads to a lot of' +
        ' concepts that are over your head and dont make ' +
        'sense. So in this video I really want to cover ' +
        'what exactly Angular is and why its even necessary... ' +
        'all from a beginners point of view.\n\n*** DOWNLOAD ' +
        'THE FREE REPORT ***\nFor my free report on the five ' +
        'best programming languages in 2019 (for beginners) ' +
        'go to: https://andysterkowitz.com/report',
      'thumbnails': {
        'default': {
      ...
      'localized': {
        'title': 'What is Angular? (Explained for Beginners)',
        'description': 'When you"re just starting out you' +
          ' are probably wondering \'What is Angular exactly? When ' +
          'you ask that question it leads to a lot of ' +
          'concepts that are over your head and dont make sense. So in ' +
          'this video I really want to cover what exactly' +
          ' Angular is and why its even necessary... all from a' +
          ' beginners point of view.\n\n*** DOWNLOAD THE' +
          ' FREE REPORT ***\nFor my free report on the five best' +
          ' programming languages in 2019 (for beginners) ' +
          'go to: https://andysterkowitz.com/report'
      },
      'defaultAudioLanguage': 'en'
    },
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'Приступаем к изучению библиотеки' +
        ' Angular. В ходе курса мы создадим небольшой' +
        ' сайт и научимся всем основным концепциям' +
        ' библиотеки Angular. Мы рассмотрим события, компоненты,' +
        ' создание форм и многое другое, чтобы вы в' +
        ' дальнейшем сами могли создавать веб сайты на Angular.' +
        '\n\n1) Курс на сайте itProger: ' +
        'https://itproger.com/course/angular\n2) Node JS: https://nodejs.org/\n3) ' +
        'Редактор кода: https://atom.io/\n4) Angular ' +
        'CLI: https://cli.angular.io/\n\n✔ Сообщество программистов:' +
        ' https://itproger.com/\n\n✔ ------------' +
        '-\nВступай в группу Вк - https://vk.com/prog_life 🚀\nГруппа' +
        ' FaceBook - https://goo.gl/XW0aaP\n\nInstagram: ' +
        'https://www.instagram.com/gosha_dudar/\nTelegram:' +
        ' http://t.me/itProger_official\nTwitter - ' +
      ...
      'defaultLanguage': 'ru',
      'localized': {
        'title': 'Уроки Angular для начинающих / #1 - ' +
          'Введение в Angular',
        'description': 'Приступаем к изучению ' +
          'библиотеки Angular. В ходе курса мы создадим небольшой ' +
          'сайт и научимся всем основным концепциям' +
          ' библиотеки Angular. Мы рассмотрим события, компоненты,' +
          ' создание форм и многое другое, чтобы ' +
          'вы в дальнейшем сами могли создавать веб сайты ' +
          'на Angular.\n\n1) Курс на сайте itProger:' +
          ' https://itproger.com/course/angular\n2) Node' +
          ' JS: https://nodejs.org/\n3) Редактор кода:' +
          ' https://atom.io/\n4) Angular CLI:' +
          ' https://cli.angular.io/\n\n✔ Сообщество' +
          ' программистов: https://itproger.com/\n\n✔ ' +
          '-------------\nВступай в группу Вк - ' +
  ...
  },
  {
    ...
    'snippet': {
      ...
      'description': 'Полный курс по Angular 8+:' +
        ...
        'Группа ВК: https://vk.com/js_by_vladilen\nTelegram:' +
        ' https://teleg.one/js_by_vladilen\nI' +
        'nstagram: https://www.instagram.com/vladilen.minin' +
        '\n\nПоддержать выпуск новых видео:\nЯД:' +
        ' https://money.yandex.ru/to/410013757655670\nPayPal:' +
        ' https://www.paypal.me/vladilenm \n\n' +
      ...
      'localized': {
        ...
        'description': 'Полный курс по Angular 8+' +
          ...
          'https://money.yandex.ru/to/410013757655670\nPayPal:' +
          ' https://www.paypal.me/vladilenm \n\nAngular ' +
          '40 вопросов для собеседования. Подготовка к интервью'
      },
      'defaultAudioLanguage': 'en-US'
    },
    'statistics': {
  ...
  },
  {
    ...
    'snippet': {
      ...
      'channelId': 'UCg8ss4xW9jASrqWGP30jXiw',
      'title': 'Angular 8 + RxJS. Приложение Органайзер ' +
        'С Нуля (Для Опытных!)',
      'description': 'Курс по Angular 8+: \nhttps://clc.to/angular ' +
        ...
        'https://money.yandex.ru/to/410013757655670\nPayPal:' +
        ' https://www.paypal.me/vladilenm \n\nВ ' +
        'видео я покажу разработку приложения органайзера ' +
        'с нуля.\nВ видео я не буду пояснять базовые ' +
        'моменты, так как это практика для опытных ' +
        'разработчиков\n\nВ результате вы получите ' +
        'приложение, в котором будет использоваться ' +
        'много RxJS, Firebase, MomentJS и Angular' +
        ' 8\nНе будет никаких CSS фреймворков - все стили ' +
        'будут написаны с нуля с использованием CSS ' +
        'переменных\n\nИсходный код:\nhttps://github.com' +
        '/vladilenm/angular-organizer\n\nAngular 8 + ' +
        'RxJS. Приложение Целиком (Для Опытных!)\nhttps:' +
        '//youtu.be/NaZwVUHnmfE',
      'thumbnails': {
        'default': {
      ...
      'localized': {
        ...
        'description': 'Курс по Angular 8+: ' +
          ...
          'https://money.yandex.ru/to/410013757655670\nPayPal:' +
          ' https://www.paypal.me/vladilenm \n\nВ видео' +
          ' я покажу разработку приложения органайзера' +
          ' с нуля.\nВ видео я не буду пояснять базовые ' +
          'моменты, так как это практика для опытных' +
          ' разработчиков\n\nВ результате вы получите ' +
          'приложение, в котором будет использоваться много ' +
          'RxJS, Firebase, MomentJS и Angular 8\nНе будет ' +
          'никаких CSS фреймворков - все стили будут ' +
          'написаны с нуля с использованием CSS переменных' +
          '\n\nИсходный код:\nhttps://github.com/vladilenm/' +
          'angular-organizer\n\nAngular 8 + RxJS. Приложение' +
  ...
  },
  {
    ...
    'snippet': {
      ...
      'title': 'Angular for Beginners - Lets build a ' +
        'Tic-Tac-Toe PWA',
      'description': 'Learn the basics of Angular 8 🚀' +
        ' by building a tic-tac-toe game 🕹️ from scratch...' +
        'Then deploy it as an installable progressive ' +
        'web app (PWA). Go beyond the basics ' +
        ...
        'fireship.quizapp\n\nUpgrade to ' +
        'Fireship PRO at https://fireship.io/pro\nUse code ' +
        'lORhwXd2 for 25% off your first payment.',
      'thumbnails': {
        'default': {
      ...
      'localized': {
        ...
        'description': 'Learn the basics of Angular 8 🚀 by' +
          ' building a tic-tac-toe game 🕹️' +
          ' from scratch...Then deploy it as an installable ' +
          'progressive web app (PWA). Go ' +
          'beyond the basics ' +
          '👉https://fireship.io/courses/angular/\n\nFull Source Code:' +
          ' https://github.com/fireship-io/angular-tic-tac-toe\n' +
          'Angular Docs:' +
          ...
          ' Angular quizzes ' +
          '🤓\n\niOS https://itunes.apple.com/us/app/fireship/id1462592372?mt=' +
          '8\nAndroid' +
          ' https://play.google.com/store/apps/details?id=io.fire' +
          'ship.quizapp\n\nUpgrade to' +
          ' Fireship PRO at https://fireship.io/pro\nUse code lOR' +
          'hwXd2 for 25% off your first payment.'
      },
      'defaultAudioLanguage': 'en'
    },
    'statistics': {
